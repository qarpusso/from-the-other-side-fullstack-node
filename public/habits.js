    ...
    habitsHTML += `
      <div class="habit-item">
        ...
        <div class="habit-actions">
          <button class="btn btn-primary btn-sm" onclick="checkOffHabit('${habit.id}', '${habit.name}')">Check</button>
          <button class="btn btn-danger btn-sm" onclick="deleteHabit('${habit.id}')" style="margin-left: 0.5rem">×</button>
        </div>
      </div>
    `
  })
